...
最近的 1.0.1-r7 迭代在日历视图中为各阶段事件引入可识别的颜色标签，Delivered 页面增加月份下拉选择以聚焦特定期的交付金额/项目数，并修复完成阶段后日历事件意外消失的问题，让交付计划在界面中更直观。
...
- 当前正式版基线：`1.0.1`
- 当前页面迭代版：`1.0.1-r7`，新增日历阶段色彩、Delivered 月份筛选和完成阶段日历渲染修复
- 本地备份目录：`backups/`
